...
import com.marketplace.auth.application.dto.ResetPasswordRequest;
...
public class ResetPasswordUseCase {
    ...
    public void execute(ResetPasswordRequest request) {
        ...
        Long userId = tokenService.parsePasswordResetToken(request.getToken())
        ...
        eventPublisher.publishEvent(new PasswordChangedEvent(userId, false));
    }
}